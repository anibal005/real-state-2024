      ...
      <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
            ...
            <div className='flex items-center gap-2'>
                ...
                >
                    <option value='regularPrice_desc'>Precio de mas alto a mas bajo</option>
                    <option value='regularPrice_asc'>Precio de mas bajo a mas alto</option>
                    <option value='createdAt_desc'>ultimos</option>
      ...
      <div className="">
        ...
        <div className="p-7 flex flex-wrap gap-4">
            {!loading && listings.length === 0 && (
                <p className="text-xl text-slate-700">Listado no encontrado!</p>
            )}
            {loading && (
