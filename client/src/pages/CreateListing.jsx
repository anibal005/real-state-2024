      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
            ...
            <div className='flex flex-wrap gap-6'>
              ...
              <div className='flex items-center gap-2'>
                <input type="number" id='precioRegular' min='1' max='10' required className='p-3 border-gray-300 rounded-lg' />
                <div className='flex flex-col items-center'>
                  <p>precio regular</p>
                  <span className='text-xs'>(Bs. / mes)</span>
                </div>
              </div>
              <div className='flex items-center gap-2'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          <p className='font-semibold'>
            Imagenes: 
            <span className='font-normal text-gray-600 ml-2'>La primera imagen sera la portada (max. 6)</span>
          </p>
          ...
          <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>Crear Listado</button>
        </div>
      </form>
    </main>
  )
